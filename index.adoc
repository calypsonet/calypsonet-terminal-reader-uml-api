...
| Returns     | The current instance (<<type_CardDetectionSettings,`CardDetectionSettings`>>).
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the provided array is not empty.
| Errors      | None.
|===
...
| Returns     | The current instance (<<type_CardDetectionSettings,`CardDetectionSettings`>>).
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the provided set is not empty.
| Errors      | None.
|===
...
| Exports the content of the previously processed selection scenario as a `String`. The result MAY be imported
  ...
  *Caution:* if the local environment does not have all the card extensions involved in the scenario, the
  ...
  card extensions.
| Returns     | A non-empty `String`.
| Pre-conditions | *State* -- the scenario has been processed successfully.
| Errors      | None.
...
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the string is well-formed.
| Errors      | None.
...
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the string is well-formed and contains no more selection cases than the current scenario.
...
| Returns     | The current instance (`T`).
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the provided regular expression is non-empty and valid.
| Errors      | None.
|===
...
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the provided array is within range.
| Errors      | None.
|===
...
| Returns     | The current instance (<<type_IsoCardSelector,`IsoCardSelector`>>).
| Pre-conditions | *Argument* -- every parameter is non-`null`. +
  *Argument* -- the provided string is valid and within range.
| Errors      | None.
|===
