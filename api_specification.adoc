...
| Signature
| `prepareSelection(` +
`{nbsp}{nbsp}cardSelector: CardSelector<?>,` +
`{nbsp}{nbsp}cardSelectionExtension: CardSelectionExtension` +
`) -> integer`
| Since       | 2.0
| Description
...
`{nbsp}{nbsp}selectionExecutionPolicy: SelectionExecutionPolicy` +
`) -> CardSelectionResult`
| Since       | 3.0
...
`{nbsp}{nbsp}reader: CardReader,` +
`{nbsp}{nbsp}channelSelectionPolicy: ChannelSelectionPolicy` +
`) -> CardSelectionResult`
| Since       | 3.0
| Description
...
`{nbsp}{nbsp}observableCardReader: ObservableCardReader,` +
`{nbsp}{nbsp}cardPresenceNotificationPolicy: CardPresenceNotificationPolicy,` +
`{nbsp}{nbsp}selectionExecutionPolicy: SelectionExecutionPolicy` +
`) -> void`
| Since       | 3.0
| Description
...
| Signature
| `startCardDetection(` +
`{nbsp}{nbsp}settings: CardDetectionSettings,` +
`{nbsp}{nbsp}eventHandler: CardReaderEventHandler` +
`) -> void`
| Since       | 3.0
| Description
...
| Signature
| `onReaderError(` +
`{nbsp}{nbsp}context: string,` +
`{nbsp}{nbsp}readerName: string,` +
`{nbsp}{nbsp}e: throwable` +
`) -> void`
| Since       | 3.0
| Description
