...
:spec-id: CNA-TR-API
:release-date: <YYMMDD>
:doc-ref: {release-date}-SP-CNATerminalAPI-Reader
...
| https://docs.terminal-api.calypsonet.org/calypsonet-terminal-definitions-uml-api/[_Terminal Definitions API Specification_] (SP-CNATerminalAPI-Definitions), version {ver-cna-td}, {organization}. Provides the `RfTechnology` and `CardType` enumerations referenced by this specification.
|===
